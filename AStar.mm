...
//*******************影响路径的障碍物***************************//
    ...
    NSString *obstacle00 = @"1505,1038,1505,1188,1740,1188,1740,1038";  //
    NSString *obstacle01 = @"1435,1038,1435,1068,1504,1068,1504,1038";  //
...
/*    NSString *obstacle00 = @"1524,901,1584,901,1583,1048,1552,1048,1551,955,1523,953";  //停车场右边绿色区域
    NSString *obstacle01 = @"1520,760,1583,760,1583,871,1520,871";  //起点右边两块并排绿色区域
    NSString *obstacle02 = @"1609,763,1629,764,1630,865,1611,867";  //绿色并排右边的绿色区域
    NSString *obstacle03 = @"1667,764,1749,764,1750,694,1776,695,1777,786,1698,786,1698,901,1668,901";  //再往右的带拐弯的区域
    NSString *obstacle04 = @"1610,670,1718,670,1718,729,1610,729";  //中间的那块绿色方块
    NSString *obstacle05 = @"1667,764,1749,764,1750,694,1776,695,1777,786,1698,786,1698,901,1668,901";  //出口下方方块
    NSString *obstacle06 = @"1497,700,1580,700,1580,740,1497,740";    //双并排方块上方横着的方块        */
